...
Remember to avoid future information leakage in your model development process."""
    ...
    example = {
        ...
        "train_dir": f"/fsx/mmts/{Path(cik_dir).name}/train",
        "val_dir": f"/fsx/mmts/{Path(cik_dir).name}/{data_split}/{sample_idx}"
    }
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cik_dirs', type=str, nargs='+', 
                        default=['/fsx/chronos-o1/dataset/finance-7/', 
                                '/fsx/chronos-o1/dataset/finance-30/', 
                                '/fsx/chronos-o1/dataset/LEU/',
                                '/fsx/chronos-o1/dataset/MSPG',
                                '/fsx/chronos-o1/dataset/PTF',
                                '/fsx/chronos-o1/dataset/medical',
                                '/fsx/chronos-o1/dataset/weather'
